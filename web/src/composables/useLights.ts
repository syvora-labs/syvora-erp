...
export type LightshowModeType = 'gradient' | 'gradient_aggressive' | 'buildup' | 'drop' | 'after_drop' | 'text' | 'spotlights' | 'vivid'
...
export interface VividConfig {
    ...
    strobe_intensity: number
    strobe_shape: 'rectangle' | 'full'
}

export type ModeConfig = GradientConfig | BuildupConfig | TextConfig | SpotlightsConfig | DropConfig | AfterDropConfig | VividConfig
...
export function getDefaultVividConfig(): VividConfig {
    return {
        colors: ['#1a0a3e', '#cc00ff', '#ff6600', '#ff0066'],
        speed: 0.4,
        morph_scale: 0.5,
        hotspot_size: 0.4,
        hotspot_color: '#ffccdd',
        hotspot_intensity: 0.8,
        bloom: 0.7,
        depth: 0.6,
        strobe_enabled: true,
        strobe_frequency: 0.5,
        strobe_intensity: 0.6,
        strobe_shape: 'rectangle',
    }
}
...
export function getDefaultConfigForType(type: LightshowModeType): ModeConfig {
    switch (type) {
        ...
        case 'vivid': return getDefaultVividConfig()
    }
}
