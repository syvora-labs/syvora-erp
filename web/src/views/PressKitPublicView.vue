...
async function startDownload() {
    ...
    try {
        const url = `${EDGE_FN_URL}?token=${token.value}&mode=zip&apikey=${encodeURIComponent(ANON_KEY)}`
        // Simplest way to trigger a file download from a browser navigation: location.assign.
